        ...
        <header className="h-14 flex items-center justify-between px-4 border-b border-slate-200 dark:border-zinc-800 bg-white dark:bg-black z-10 flex-shrink-0">
            <div className="flex items-center gap-3 flex-1">
                ...
                <div className="relative max-w-md w-full md:w-64 hidden md:block">
                    ...
                    <input type="text" placeholder="検索" className="w-full pl-9 pr-4 py-1.5 bg-slate-100 dark:bg-zinc-900 rounded-lg text-sm focus:outline-none dark:text-slate-200" />
                </div>
            </div>
