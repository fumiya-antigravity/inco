...
import {
 Menu, Home, CheckCircle2, Bell, ChevronRight, ChevronDown, Plus
} from 'lucide-react';
...
const Sidebar = () => {
 ...
 <div
 className={`
 bg-slate-900 text-slate-300 flex-col shadow-xl z-20 border-r border-slate-800 flex-shrink-0 transition-all duration-300 overflow-hidden
