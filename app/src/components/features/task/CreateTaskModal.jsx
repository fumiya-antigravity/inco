...
const CreateTaskModal = ({ isOpen, onClose }) => {
 ...
 className="w-full text-xl font-bold placeholder-slate-300 border-none outline-none bg-transparent text-slate-800"
 placeholder="タスク名を入力..."
 autoFocus
 />
 ...
 className="appearance-none bg-slate-50 border border-slate-200 rounded-lg pl-3 pr-8 py-2 font-medium focus:ring-2 focus:ring-emerald-500/20 outline-none"
 >
 {projects.map(p => (
 ...
 className="bg-slate-50 border border-slate-200 rounded-lg px-3 py-[7px] font-medium focus:ring-2 focus:ring-emerald-500/20 outline-none"
 />
 </div>
 </div>
 </div>
 ...
 className="w-full h-32 p-3 bg-slate-50 border border-slate-200 rounded-xl resize-none focus:ring-2 focus:ring-emerald-500/20 outline-none transition-all text-sm"
 placeholder="詳細説明..."
 />
 </div>
